...
Mobile.setText(findTestObject('Object Repository/Logout/android.widget.EditText'), 'ahmad3@gmail.com', 0)

Mobile.setText(findTestObject('Object Repository/Logout/android.widget.EditText (1)'), 'ahmad3', 0)
